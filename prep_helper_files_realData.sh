...
## get chrm, pos, ref and alt from vcf file

bcftools view -c 1 -c 1:nonmajor --max-alleles 2 --exclude-types indels allbams_final.vcf.gz > allbams_final.biallelic.vcf.gz  
bcftools query -f '%CHROM %POS %REF %ALT\n' allbams_final.biallelic.vcf.gz | sed 's/[[:space:]]\+/\t/g' > $basedir/target_SNP_file_realData
